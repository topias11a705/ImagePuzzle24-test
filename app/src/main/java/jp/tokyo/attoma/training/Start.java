...
//フィルターを掛ける（αＲＧＭ）
	...
	//---------------------------------------------------------
	@Override public void onResume() {Log.i("memory","Start onStart");super.onResume();}
	@Override public void onPause() {Log.i("memory","Start onStart");super.onPause();}
	@Override protected void onStart() {Log.i("memory","Start onStart");super.onStart();}
	@Override protected void onRestart() {Log.i("memory","Start onRestart");super.onRestart();}
	@Override protected void onStop() {Log.i("memory","Start onStop");super.onStop();}
	@Override protected void onDestroy() {Log.i("memory","Start onDestroy");super.onDestroy();}
	//-------------------------------------------------------------------
}